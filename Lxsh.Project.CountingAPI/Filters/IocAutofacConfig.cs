...
using Lxsh.Project.CountingInterface;
using System;
...
namespace Lxsh.Project.CountingAPI
{
    public  class IocAutofacConfig
    {
        public static void RegisterDependencies()
        {
            ...
            //自动注册控制器
            builder.RegisterControllers(typeof(WebApiApplication).Assembly).PropertiesAutowired();//把当前程序集中的Controller 都注册     
            Assembly[] asmService = new Assembly[] { Assembly.Load("Lxsh.Project.CountingService") };
